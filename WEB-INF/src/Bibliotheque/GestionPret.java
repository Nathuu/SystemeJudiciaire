...
public class GestionPret
{
     ...
     */
    public void preter(int idLivre, int idMembre, String datePret) throws SQLException, BiblioException, Exception
    {
        try
        {
            ...
            if (!tupleLivre.isIdMembreNull())
                throw new BiblioException("Livre " + idLivre + " deja prete a " + tupleLivre.getIdMembre());
            ...
            if (tupleMembre.getNbPret() >= tupleMembre.getLimitePret())
                throw new BiblioException("Limite de pret du membre " + idMembre + " atteinte");
    ...
    public void renouveler(int idLivre, String datePret) throws SQLException, BiblioException, Exception
    {
        try
        {
            ...
            // Enregistrement du pret.
            int nb1 = livre.preter(idLivre, tupleLivre.getIdMembre(), datePret);
            if (nb1 == 0)
